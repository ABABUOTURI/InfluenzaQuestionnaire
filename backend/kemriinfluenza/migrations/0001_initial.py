# Generated by Django 5.0.12 on 2025-03-14 12:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('siblings_have_partners', models.CharField(choices=[('YES', 'YES'), ('NO', 'NO')], max_length=3)),
                ('pocket_money_adequate', models.CharField(choices=[('YES', 'YES'), ('NO', 'NO')], max_length=3)),
                ...
                ('alternative_visitor', models.CharField(choices=[('Boyfriend', 'Boyfriend'), ('Relatives', 'Relatives'), ('Brothers/Sisters', 'Brothers/Sisters'), ('Man friend', 'Man friend'), ('None', 'None')], max_length=20)),
                ('access_to_reproductive_health_info', models.CharField(choices=[('YES', 'YES'), ('NO', 'NO')], max_length=3)),
                ('information_adequate', models.CharField(choices=[('YES', 'YES'), ('NO', 'NO')], max_length=3)),
                ('educator_name', models.CharField(choices=[('Teacher', 'Teacher'), ('Parents', 'Parents'), ('Health worker', 'Health worker'), ('Friends', 'Friends'), ('Radio/Magazine/TV', 'Radio/Magazine/TV')], max_length=200)),
                ('topic_name', models.CharField(choices=[('Sexuality', 'Sexuality'), ('Abstinence', 'Abstinence'), ('Condoms', 'Condoms'), ('HIV/STI', 'HIV/STI'), ('Relationships', 'Relationships')], max_length=200)),
